    ...
    <Card className='h-fit w-full border-white/10 bg-white/5 text-white shadow-none'>
      <CardHeader className='space-y-4'>
        <div className='flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between'>
          ...
          <div className='rounded-2xl border border-sky-300/35 bg-[radial-gradient(circle_at_18%_18%,rgba(125,211,252,0.2),transparent_28%),linear-gradient(180deg,rgba(241,245,249,0.96),rgba(226,232,240,0.92))] px-4 py-3 shadow-[0_22px_48px_-32px_rgba(56,189,248,0.26)] ring-1 ring-slate-200/75'>
            <p className='text-[11px] font-semibold tracking-[0.16em] text-slate-700 uppercase'>
              Overall Score
            </p>
            <div className='mt-1 flex items-end gap-2'>
              <p className='text-4xl font-semibold tracking-tight text-slate-900'>78/100</p>
              <span className='pb-1 text-sm font-medium text-slate-700'>Benchmark vs industry</span>
            </div>
          </div>
        </div>
      </CardHeader>
      ...
      <CardContent className='grid items-start gap-5 lg:grid-cols-[1.05fr_0.95fr]'>
        <div className='w-full min-w-0 self-start rounded-3xl border border-white/10 bg-[radial-gradient(circle_at_50%_40%,rgba(56,189,248,0.12),transparent_34%),linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] p-3 sm:p-5 lg:max-w-[26rem] lg:justify-self-center'>
          ...
          <div className='-mx-2 sm:mx-0'>
            ...
            >
              ...
              {scoreItems.map((item, index) => {
                ...
                const labelPoint = getRadarPoint(axisAngles[index], RADAR_RADIUS + 18);
