    ...
    <div className='grid gap-4 md:grid-cols-3'>
      {stats.map((stat) => (
        <Card
          key={stat.label}
          className={cn(
            'relative isolate overflow-hidden border-white/65 bg-white/45 shadow-[0_18px_40px_-28px_rgba(15,23,42,0.2),0_8px_18px_-16px_rgba(15,23,42,0.12)] backdrop-blur-md transition-[background-color,border-color,box-shadow,transform] duration-[1600ms] ease-[cubic-bezier(0.22,1,0.36,1)] motion-reduce:transition-none',
