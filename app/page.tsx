  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset className='bg-transparent'>
        <header
          className='sticky top-0 z-10 flex h-16 shrink-0 items-center border-b border-border/60 bg-background/80 px-4 backdrop-blur sm:px-6'
          data-landing-header
        >
          <div className='flex items-center gap-3'>
            ...
            <div>
              ...
              <p className='text-xs text-muted-foreground'>Sidebar-07 landing page scaffold</p>
            </div>
          </div>
        </header>

        <main className='scroll-smooth px-4 py-6 sm:px-6 lg:px-8'>
                ...
                <CardHeader className='gap-4 pb-4 sm:pb-6'>
                  ...
                  <div className='max-w-3xl space-y-4'>
                    ...
                    <CardDescription className='text-base sm:text-lg'>
                      The left navigation drives the entire single-page flow. Each item anchors to a
                      section, while the main content stays vertically scrollable inside the inset
                      layout.
                    </CardDescription>
                  </div>
                </CardHeader>
